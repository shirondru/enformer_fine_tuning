...
#SBATCH --job-name=ISM_SG_Blood_Test
...
subset=$1
n_subsets=$2
path_to_only_genes_file=../data/genes/Whole_Blood/test_genes.txt

python $script_path --path_to_metadata $path_to_metadata --model_type $model_type --subset $subset --n_subsets $n_subsets --path_to_only_genes_file $path_to_only_genes_file
