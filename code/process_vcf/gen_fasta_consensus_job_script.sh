...
/pollard/data/projects/sdrusinsky/bcftools-1.17/bcftools consensus --fasta-ref=$TMPDIR/ref_fasta.fa --haplotype=$haplotype --samples=$sample $TMPDIR/bcf_in.bcf.gz -o $TMPDIR/${sample}_consensus_H${haplotype}.fa 
