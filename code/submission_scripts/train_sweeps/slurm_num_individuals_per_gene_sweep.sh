...
#SBATCH --job-name=NIndivsPerGeneSweep
...
#run with default settings to make sure you get same results as before
num_individuals_per_gene=$1
python ./train_training_sweep.py --num_individuals_per_gene $num_individuals_per_gene